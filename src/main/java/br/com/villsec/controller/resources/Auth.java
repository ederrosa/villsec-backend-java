...
import br.com.villsec.model.services.AuthServices;
import br.com.villsec.model.services.UserLoggedInService;
import br.com.villsec.model.services.dtos.EmailDTO;
...
public class Auth {
	...
	public ResponseEntity<Void> refreshToken(HttpServletResponse response) {
		AutenticacaoSS user = UserLoggedInService.authenticated();
	...
	public ResponseEntity<Void> forgot(@Valid EmailDTO objDto) {
